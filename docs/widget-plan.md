...
**26 of 30 CSV widgets built**, plus two chat primitives (`text`, `widget_response`) and one companion (`evidence_review`, worker-facing sibling of QC Evidence Review).

**Last shipped:** Signature Capture (#14) — landed across `425dde4` (Pass 2 close) / `a059c2b` (Pass 2 elevation) / `bdc403d` (Pass 1 close) / `beeea04` / `90569ec` / `d5cfedb` / `b435b1e` / `aadefa3` (Pass 1 regions 5 → 1) / `9959d3e` (spec).

**Pending:** 4 widgets — all P2 (Phase 2+). All P0 and P1 widgets complete.
